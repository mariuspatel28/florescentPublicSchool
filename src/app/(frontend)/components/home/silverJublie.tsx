...
// export async function SilverJubilee() {
//   return (
...
//               <div className="w-full h-full rounded-full border-4 border-[#1e3a5a] flex flex-col items-center justify-center bg-gradient-to-br from-white via-slate-50 to-slate-100">
//                 <motion.div
...
//                     25
//                   </span>
//                   <span className="block text-[10px] md:text-xs font-bold text-[#1e3a5a] uppercase tracking-[0.3em] mt-1">
//                     Years
//                   </span>
//                 </motion.div>
//               </div>
...
//             <h2 className="text-4xl md:text-7xl font-black text-[#1e3a5a] tracking-tighter">
